...
5. On first page load, enter `ws://ESP32_IP/ws`, click **Connect ESP32**, then **Start calibration**. Relax for five seconds, then follow five short prompts: squeeze firmly for about one second, release for about one second, and repeat.
